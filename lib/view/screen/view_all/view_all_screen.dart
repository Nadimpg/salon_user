  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Scaffold(
          ...
          extendBody: true,
          appBar: CustomAppBar(
            appBarContent: CustomBack(text: "Featured Providers".tr),
          ),
          body: Obx(() {
            switch (featuredController.rxRequestStatus.value) {
              case Status.loading:
              ...
              case Status.error:
                return GeneralErrorScreen(onTap: () {
                  featuredController.featuredProviders();
                });
              case Status.completed:
                return featuredController.featuredList.isEmpty?const Center(
                  child: CustomText(
                    text: 'Empty',
                    fontSize: 16,
                    color: Colors.white,
                  ...
                  itemCount: featuredController.featuredList.length,
                      ...
                      onTap: () {
                        setState(() {
                          ...
                          Get.toNamed(AppRoute.homeCardDetails,
                              arguments:
                                  featuredController.featuredList[index].id);
                        });
                      },
                      child: Container(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      CustomText(
                                          text: featuredController
                                              .featuredList[index].averageRating
                                              .toString(),
                                          fontSize: 12,
                                          fontWeight: FontWeight.w600,
                                          maxLines: 2,
